...
-  **Fitbit Data Types:**
	...
	- To read more about [Fitbit data types](https://dev.fitbit.com/build/reference/web-api/).  => Still Not implemented all the data type retrieving  in my code.
 
 - **Google Fit Data Types:**

	- To read more about [Google Fit Data types](https://developers.google.com/fit/datatypes). => Still Not implemented all the data type retrieving  in my code.
...
- One of the popular SSLs: [OpenSSL](https://www.openssl.org/) => Still Not implemented in my code.
...
- Also, [Web API](https://dev.fitbit.com/build/reference/web-api/)
